...
const UserDetailPage = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-4">
      ...
      {/* 삭제 버튼 */}
      <button
        className="w-full mb-8 py-2 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-lg transition"
        onClick={() => {
          if (window.confirm('정말로 사용자를 삭제하시겠습니까?')) {
            // 실제 삭제 로직: 예시로 alert 및 상태 초기화
            alert('사용자가 삭제되었습니다.');
            setName('');
            setEmail('');
            setJoinDate('');
