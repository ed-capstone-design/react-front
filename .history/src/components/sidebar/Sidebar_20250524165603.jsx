...
const menu = [
  ...
  { id:2, name: "운전자 관리", path: "/drivers", icon: <IoPeopleOutline /> },
  { id: 3, name: "운행 스케줄", path: "/operating-schedule", icon: <IoCalendarOutline /> },
  { id: 4,name: "인사이트", path: "/insight", icon: <IoBarChartOutline /> },
  { id:5 , name: "사용자 상세", path: "/userdetailpage", icon: <IoPersonCircleOutline /> },
];
