...
const OperatingSchedule = ({ onDriveDetail }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4">
      <h2 className="text-2xl font-bold mb-8 text-blue-700">운행 스케줄</h2>
      <table className="w-full bg-white rounded-2xl shadow-xl text-left border border-blue-50">
        <thead>
          <tr>
      ...
      <div className="flex justify-end mt-6">
        <button
          className="bg-gradient-to-r from-blue-600 to-blue-400 text-white px-6 py-2 rounded-full font-bold shadow hover:from-blue-700 hover:to-blue-500 transition"
