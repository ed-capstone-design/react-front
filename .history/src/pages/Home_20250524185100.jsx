...
const menu = [
  { name: "대시보드", id: "dashboard", component: <Dashboard /> },
  { name: "운전자 관리", id: "drivers", component: <Drivers /> },
  { name: "운행 스케줄", id: "operating-schedule", component: <OperatingSchedule /> },
  { name: "인사이트", id: "insight", component: <Insight /> }
];
...
const Home = () => {
  ...
  const selectedMenu = menu.find((item) => item.id === selected);
